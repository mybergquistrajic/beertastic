...
//Checks that the user data isn't empty and that the user is over 18 and the lenght of the 
//password is shorter than 5 characters 
if($r_data["username"] == "" or strln($r_data["password"]) < 5 or $r_data["password"] == "" or $r_data["age"] < 18){
